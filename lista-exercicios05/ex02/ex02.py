...
for servidor in dictServidores:
    ...
    sigla_campus = campus_info[11] if len(campus_info) >= 12 else None

    categoria = servidor[0][1].split(';')[0]

    # Se a sigla_campus já existe no dicionário de resultados, atualize a quantidade correspondente à categoria
